...
type DeleteExecutionURL struct {
	JobID     string
	ProjectID string
...
func (o *DeleteExecutionURL) Build() (*url.URL, error) {
	...
	if jobID != "" {
		...
		return nil, errors.New("jobId is required on DeleteExecutionURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on DeleteExecutionURL")
	}
...
func (o *DeleteExecutionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteExecutionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteExecutionURL")
	}
