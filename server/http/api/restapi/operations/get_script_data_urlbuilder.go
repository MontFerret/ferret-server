...
func (o *GetScriptDataURL) Build() (*url.URL, error) {
	...
	if dataID != "" {
		...
		return nil, errors.New("dataId is required on GetScriptDataURL")
	}
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on GetScriptDataURL")
	}
	...
	if scriptID != "" {
		...
		return nil, errors.New("scriptId is required on GetScriptDataURL")
	}
...
func (o *GetScriptDataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetScriptDataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetScriptDataURL")
	}
