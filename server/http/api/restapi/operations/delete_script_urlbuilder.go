...
func (o *DeleteScriptURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on DeleteScriptURL")
	}
	...
	if scriptID != "" {
		...
		return nil, errors.New("scriptId is required on DeleteScriptURL")
	}
...
func (o *DeleteScriptURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteScriptURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteScriptURL")
	}
