...
type DeleteScriptDataURL struct {
	DataID    string
	ProjectID string
	ScriptID  string
...
func (o *DeleteScriptDataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteScriptDataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteScriptDataURL")
	}
