...
// NewGetScriptDataParams creates a new GetScriptDataParams object
// no default values defined in spec.
func NewGetScriptDataParams() GetScriptDataParams {

	return GetScriptDataParams{}
}

// GetScriptDataParams contains all the bound params for the get script data operation
// typically these are obtained from a http.Request
//
// swagger:parameters getScriptData
type GetScriptDataParams struct {
...
func (o *GetScriptDataParams) bindDataID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetScriptDataParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetScriptDataParams) bindScriptID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
